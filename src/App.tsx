...
const Detail = lazyComponent(() => import("./pages/Detail"));
const Player = lazyComponent(() => import("./pages/Player"));
...
function lazyComponent<T extends React.ComponentType<React.PropsWithChildren<unknown>>>(importFn: () => Promise<{ default: T }>) {
  ...
  return function LazyWrapper(props: React.ComponentProps<T>) {
    return (
      <Suspense fallback={<div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "60vh" }}><div className="player-loading-spinner" /></div>}>
        <Lazy {...props} />
      </Suspense>
    );
  };
